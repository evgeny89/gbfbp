...
function ProductThumbComponent({productData, productIdChange}) {
    return (
        <div className="product__thumb" >
            <div className="image__wrapper">
                <div className="button__remove">
                    <div className="remove__icon" data-product-id={productData.id}></div>
                </div>
                <img src={productData.image} className="product__image" alt=""/>
            </div>
            <div className="product__caption">
                ...
                <div className="product__buttons">
                    <button className="button__edit" data-product-id={productData.id} onClick={productIdChange}>
